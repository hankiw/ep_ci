    ...
    var ConstructScreen = function( Param ) {   
        ...
        function ImportCert( obj, textObj ) {
            ...
            try {
                ...
                forresultpage = 'unisignweb/rsrc/layout/mobile/w2a/m_importcertresult.html'; //subUrl + SANDBOX.ESVS.SRCPath + 'proxy.html'; // 
...
//              </li>
        ...
        function WindowGenerate() {
            ...
            certGetBtn.onclick = function(){  ImportCert(this, __lang); }; //CallPFXImportFunc(__lang); }; // test
